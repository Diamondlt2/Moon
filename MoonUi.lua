 local Player = game:GetService("Players").LocalPlayer
    ...
    local Themes = {
        Light = {
            ...
            Maximise = Color3.fromRGB(125,125,125),
            MaximiseAccent = Color3.fromRGB(125,125,125),
            ...
            ButtonAccent = Color3.fromRGB(30,30,30),
            ...
            DropdownAccent = Color3.fromRGB(24,24,24),
        ...
        Dark = {
            ...
            NavBarAccent = Color3.fromRGB(14,14,14),
            NavBarInvert = Color3.fromRGB(0,0,0),
            TitleBar = Color3.fromRGB(14,14,14),
            TitleBarAccent = Color3.fromRGB(255,255,255),
            Overlay = Color3.fromRGB(24, 24, 24),
            Banner = Color3.fromRGB(30,30,30),
    ...
    function CreateNewButton(ButtonConfig, Parent)
        ...
        Button.ImageColor3 = Color3.fromRGB(24,24,24) -- 30
        ...
        Button.MouseButton1Down:Connect(function()
            CircleAnim(ButtonLabel, Color3.fromRGB(255,255,255), Color3.fromRGB(24,24,24))
            ButtonCallback()
        end)
    ...
    function Material.Load(Config)
        ...
        function TabLibrary.New(TabConfig)
            ...
            function OptionLibrary.Dropdown(DropdownConfig)
                ...
                DropdownBar.ImageColor3 = Color3.fromRGB(24,24,24)
                ...
                DropdownTextbox.TextTransparency = 0
                ...
                DropdownToggle.ImageColor3 = Color3.fromRGB(40,40,40)
                ...
                DropdownButton.ImageColor3 = Color3.fromRGB(255,255,255)
                ...
                TweenService:Create(DropdownTextbox, TweenInfo.new(0.5), {TextTransparency = 0}):Play()
            ...
            if(Entry ~= "") then
                for i,v in next, DropdownContent:GetChildren() do
                    ...
                    if(v and v:FindFirstChild("TextLabel") and v.TextLabel.Text:gsub("%s", ""):lower():sub(1, #Entry) == Entry) then
                         find = true
                        end
                        if(not find) then
            ...
            function OptionLibrary.Toggle(ToggleConfig)
                ...
                Toggle.ImageColor3 = Color3.fromRGB(14,14,14)
                ...
                ToggleTracker.ImageColor3 = Color3.fromRGB(30,30,30)
                ...
                DotShadow.ImageColor3 = Color3.fromRGB(30,30,30)
